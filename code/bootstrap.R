...
plot(load_combined_small$KHOU,load_combined_small$COAST,col=rgb(0,0,0,alpha=0.5),pch=19,cex=0.8,xlab="temperature (F)",ylab="power demand",ylim=c(6000,20000),xlim=c(20,106))
x = load_combined$KHOU
xmin = floor(min(x))
xmax = floor(max(x))
xnew = seq(xmin,xmax,length.out=500)
